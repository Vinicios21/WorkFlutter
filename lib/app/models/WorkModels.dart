class WorkModels {
  ...
  WorkModels(this.id, this.parkingSpotNumber, this.licensePlateCar,
      this.brandCar, this.modelCar, this.colorCar, this.registrationDate,
      this.responsibleName, this.apartment, this.block);

  WorkModels.fromJson(Map<String, dynamic> json) :
